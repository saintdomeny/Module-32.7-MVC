...
using Module_32._7_MVC.Middlewares;
...
namespace Module_32._7_MVC
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IBlogRepository, BlogRepository>();//Изменено на scoped instead of singleton
